...
namespace gamezone_api.Repositories
{
	public class ProductVariantsRepository
	{
		...
		public ProductVariantsRepository(GamezoneContext dbContext, ProductVariantsMapper productVariantsMapper)
		{
			context = dbContext;
			this.productVariantsMapper = productVariantsMapper;
		}
