...
namespace gamezone_api.Migrations
{
    ...
    [Migration("20230518220017_RemoveHasIndexOnPhoneUsersTable")]
    partial class RemoveHasIndexOnPhoneUsersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("gamezone_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 18, 16, 0, 17, 757, DateTimeKind.Local).AddTicks(3960),
                            Email = "alec@gmail.com",
                            FirstName = "Alec",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)329-1243",
                            UpdateDate = new DateTime(2023, 5, 18, 16, 0, 17, 757, DateTimeKind.Local).AddTicks(3990)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            CreateDate = new DateTime(2023, 5, 18, 16, 0, 17, 757, DateTimeKind.Local).AddTicks(4000),
                            Email = "alexis@gmail.com",
                            FirstName = "Alexis",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)937-3897",
                            UpdateDate = new DateTime(2023, 5, 18, 16, 0, 17, 757, DateTimeKind.Local).AddTicks(4000)
                        },
                        new
                        {
                            Id = 3L,
                            ...
                            Password = "123456",
                            Phone = "(664)467-2145",
                            UpdateDate = new DateTime(2023, 5, 18, 16, 0, 17, 757, DateTimeKind.Local).AddTicks(4010)
                        },
                        new
                        {
                            Id = 4L,
                            ...
                            CreateDate = new DateTime(2023, 5, 18, 16, 0, 17, 757, DateTimeKind.Local).AddTicks(4010),
                            Email = "aop@gmail.com",
                            FirstName = "Armando",
