...
namespace gamezone_api.Migrations
{
    ...
    [Migration("20230522173037_AddParentCategoryIdCategoriesTable")]
    partial class AddParentCategoryIdCategoriesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("gamezone_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 22, 11, 30, 37, 203, DateTimeKind.Local).AddTicks(9170),
                            Email = "alec@gmail.com",
                            FirstName = "Alec",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)329-1243",
                            UpdateDate = new DateTime(2023, 5, 22, 11, 30, 37, 203, DateTimeKind.Local).AddTicks(9230)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            CreateDate = new DateTime(2023, 5, 22, 11, 30, 37, 203, DateTimeKind.Local).AddTicks(9240),
                            Email = "alexis@gmail.com",
                            FirstName = "Alexis",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)937-3897",
                            UpdateDate = new DateTime(2023, 5, 22, 11, 30, 37, 203, DateTimeKind.Local).AddTicks(9240)
                        },
                        new
                        {
                            Id = 3L,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 22, 11, 30, 37, 203, DateTimeKind.Local).AddTicks(9250),
                            Email = "aop@gmail.com",
                            FirstName = "Armando",
                            LastName = "Ortega Partida",
                            Password = "123456",
                            Phone = "(664)894-4378",
                            UpdateDate = new DateTime(2023, 5, 22, 11, 30, 37, 203, DateTimeKind.Local).AddTicks(9250)
                        },
                        new
                        {
                            Id = 5L,
