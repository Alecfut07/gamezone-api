...
namespace gamezone_api.Migrations
{
    ...
    [Migration("20230519171410_AddCategoriesTable")]
            ...
            modelBuilder.Entity("gamezone_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 19, 11, 14, 10, 865, DateTimeKind.Local).AddTicks(6110),
                            Email = "alec@gmail.com",
                            FirstName = "Alec",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)329-1243",
                            UpdateDate = new DateTime(2023, 5, 19, 11, 14, 10, 865, DateTimeKind.Local).AddTicks(6170)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            CreateDate = new DateTime(2023, 5, 19, 11, 14, 10, 865, DateTimeKind.Local).AddTicks(6170),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 19, 11, 14, 10, 865, DateTimeKind.Local).AddTicks(6180),
                            Email = "armando@gmail.com",
                            FirstName = "Armando",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)467-2145",
                            UpdateDate = new DateTime(2023, 5, 19, 11, 14, 10, 865, DateTimeKind.Local).AddTicks(6180)
                        },
                        new
                        {
                            Id = 4L,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 19, 11, 14, 10, 865, DateTimeKind.Local).AddTicks(6190),
                            Email = "patricia@gmail.com",
                            FirstName = "Patricia",
                            LastName = "Cisneros Mayoral",
                            Password = "123456",
                            Phone = "(664)399-1289",
                            UpdateDate = new DateTime(2023, 5, 19, 11, 14, 10, 865, DateTimeKind.Local).AddTicks(6190)
                        });
                });
