...
namespace gamezone_api.Migrations
{
    ...
    [Migration("20230523165532_AddCategoriesProductVariantsTable")]
    partial class AddCategoriesProductVariantsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("gamezone_api.Models.CategoryProductVariant", b =>
                {
                    ...
                    b.HasKey("CategoryId", "ProductVariantId");
            ...
            modelBuilder.Entity("gamezone_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 23, 10, 55, 31, 964, DateTimeKind.Local).AddTicks(1530),
                            Email = "alec@gmail.com",
                            FirstName = "Alec",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)329-1243",
                            UpdateDate = new DateTime(2023, 5, 23, 10, 55, 31, 964, DateTimeKind.Local).AddTicks(1580)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            CreateDate = new DateTime(2023, 5, 23, 10, 55, 31, 964, DateTimeKind.Local).AddTicks(1580),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 23, 10, 55, 31, 964, DateTimeKind.Local).AddTicks(1590),
                            Email = "armando@gmail.com",
                            FirstName = "Armando",
                            LastName = "Ortega",
                            Password = "123456",
                            Phone = "(664)467-2145",
                            UpdateDate = new DateTime(2023, 5, 23, 10, 55, 31, 964, DateTimeKind.Local).AddTicks(1590)
                        },
                        new
                        {
                            Id = 4L,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 23, 10, 55, 31, 964, DateTimeKind.Local).AddTicks(1600),
                            Email = "patricia@gmail.com",
                            FirstName = "Patricia",
                            LastName = "Cisneros Mayoral",
                            Password = "123456",
                            Phone = "(664)399-1289",
                            UpdateDate = new DateTime(2023, 5, 23, 10, 55, 31, 964, DateTimeKind.Local).AddTicks(1600)
                        });
                });
