	...
	public class ProductsSeed
	{
		public static List<Product>? InitData()
		{
			List<Product> productsInit = new List<Product>
			{
				...
				new Product() { Name = "Super Mario Galaxy", Description = "Nintendo Wii Game", ReleaseDate = new DateTime(2007, 11, 12), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, ImageURL = "https://static.wikia.nocookie.net/nintendo/images/0/00/Super_Mario_Galaxy_%28EU%29.jpg/revision/latest?cb=20090401224138&path-prefix=en" },
				...
				new Product() { Name = "Metroid Prime", Description = "Nintendo Gamecube Game", ReleaseDate = new DateTime(2002, 11, 17), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, ImageURL = "https://static.wikia.nocookie.net/metroid/images/b/ba/MetroidPrimebox.jpg/revision/latest?cb=20220716192249" },
				...
				new Product() { Name = "Tekken 3", Description = "PlayStation 1 Game", ReleaseDate = new DateTime(1998, 4, 29), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, ImageURL = "https://static.wikia.nocookie.net/gamia_gamepedia_en/images/9/99/Front-Cover-Tekken-3-EU-PS1.jpg/revision/latest?cb=20180806163905" },
